...
We sought to define the impact of time and distance on SARS-CoV-2 surface contamination through longitudinal sampling of surfaces within COVID-19 patient rooms. We found that distance from the patient's head of bed did not have a significant impact on the probability of detection of SARS-CoV-2 RNA. We had hypothesized that the probability of RNA detection with decrease with distance. However, we found that detection did not vary significantly among any surface group with increased distance. This is likely related to two factors 1) the relatively small size of patient rooms and 2) the physical spread of viral RNA through touch. We observed large differences in the probability of detecting surface contamination by surface type. Floors had high probability of contamination, which did not vary throughout the room. This is likely related to both the role of patient and HCP feet as well as the physical action of mopping which spread body fluids containing viral RNA within the patient's room. In contrast, walls had significantly lower probability of contamination. This may be due to the decreased settling of respiratory droplets on vertical surfaces. This finding matches previous description of high probability of floor contamination relative to other surfaces [@Chia2020]. 

While we did not observe a measurable impact of distance on the probability of surface contamination with SARS-CoV-2 RNA, we did detect a decrease in probability of detection among both high and low-touch surfaces with time from COVID-19 diagnosis. A similar finding was described by Chia et al [@Chia2020], where patients over 7 days from illness had lower probability of surface contamination within rooms. Interestingly, while the probability of floor contamination decreased with time from diagnosis, the probability remained relatively high at later time points. Combined with the finding that the probability of floor contamination increased with time from the onset of the second COVID-19 Wave, this suggests that external contamination accounts for a significant proportion of floor contamination. Viral RNA carried on the feet of healthcare personnel or the mops of EVS teams may have resulted in increased probability of detection as COVID-19 census increased. Guo et al [@Guo2020] described that floor contamination was discovered in areas where clinical care was not performed, and suggested that it was spread by the feet of HCP.
  
Our findings are significant as they reveal that varied distances within a patient room have similar probability of surface contamination. This finding supports CDC recommended infection control practices [@CDCInfectionControl]. Additionally, our findings highlight the role of touch in surface contamination of patient rooms and the likelihood of extrinsic contamination on SARS-CoV-2 units.

Our study has several limitations. First, our study used quantitative PCR for the detection of SARS-CoV-2 RNA and did not use viral culture to determine the viability from surfaces. Secondly, we did not control for cleaning methods on study units. However, cleaning practices did not undergo significant changes during the study time period and sampling was performed routinely prior to daily cleaning. Finally, while we explored patient characteristics impacted the decay of surface contamination with time and distance, there was limited variability of some measures, making independent associations with viral detection less feasible.
